 ...
 <div className="container">
    <div className="row align-items-center">
          <div className="col-md-6">
              ...
              <h1 className="col-white">Discover, find, and <br></br><span style={{color:'#8364e2'}}>Sell Extraordinary</span><br></br>NFT Apparel.</h1>
              </Reveal>
              ...
              <span onClick={()=> window.open("#", "_self")} className="btn-main inline lead">Create</span>
          ...
          <Reveal className='onStep d-inline' keyframes={inline} delay={300} duration={1200} triggerOnce>
              <img src="./img/misc/Graphic.svg"  className="img-fluid" alt=""/>
          </Reveal>
</div>*/}
      </div>
    </div>
